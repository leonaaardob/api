CREATE TABLE "public"."lobbies" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "status" text NOT NULL, "created_at" timestamptz NOT NULL DEFAULT now(), PRIMARY KEY ("id") );
CREATE EXTENSION IF NOT EXISTS pgcrypto;

alter table "public"."lobbies"
  add constraint "lobbies_status_fkey"
  foreign key ("access")
